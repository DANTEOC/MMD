...
import { addWorkOrderLine, type AddLineData } from '@/app/actions/work-order-lines';
...
export default function AddLineModal({ workOrderId, onClose, onSuccess }: AddLineModalProps) {
    ...
    const filteredItems = catalogItems.filter(i => i.kind === formData.kind);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const result = await addWorkOrderLine(workOrderId, formData);
